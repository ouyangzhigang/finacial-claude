...
## 🚨 Critical Rules
1. **催化兑现度是命门(8-11升级双维)**:个股兑现度(近5日涨>15%半兑现/>30%透支)× 板块兑现度(板块5日涨>20%或龙头滞涨=退潮透支)双维交叉。**个股未涨≠未price-in**——板块退潮时个股未涨是弱势非蓄势,必须先判板块阶段再判个股。催化临近但板块已退潮 → 整板块降权。
...
### 兑现度判断(关键)——板块兑现度 × 个股兑现度 双维交叉(8-11升级)

> ⚠️ 病根:旧版只看个股近5日涨幅判断兑现度,个股未涨就判"未price-in蓄势"——但板块退潮时个股未涨是弱势不是蓄势。8-07电网跟风票个股未涨被误判"蓄势待涨",实则板块已退潮。现升级为双维交叉。

**板块兑现度表**(先判板块,用 `sector_lifecycle.py` 的 verdict + 板块5日涨幅):
| 板块5日涨幅 | 板块兑现度 | 处置 |
|---|---|---|
| <3% + 启动期 | 板块未price-in | 跟风flat票=真蓄势,**可选加分** |
| 3-10% + 发酵期 | 板块启动 | 跟风补涨票正常选 |
| 10-20% | 板块半兑现 | 跟风票补涨空间收窄,降权 |
| >20% + 高潮期 | 板块透支 | 只选龙头,跟风票不选(补涨空间已小) |
| 龙头滞涨/炸板 | 板块退潮 | **整板块否决**,个股未涨=弱势非蓄势 |

**个股兑现度表**(再判个股,基于个股近5日涨幅 vs 板块涨幅):
| 个股近5日涨幅 | 个股兑现度 | 处置 |
|---|---|---|
| <5% | 未price-in | 正常加分 |
| 5-15% | 启动 | 正常 |
...
- 个股未涨(<5%) + 板块退潮/高潮期 → **弱势滞涨**,不是蓄势,降权或剔除(8-07电网跟风票即此)
- 个股未涨 + 板块5日涨>15%(半兑现) → 个股跑输板块=弱,**不选**(板块半兑现时跟风弱票补涨空间已被龙头吃完)
- 个股已涨>15% + 板块启动期 → 半兑现但板块未透支,可观察(龙头位置)
- 个股已涨>30% → 已透支,不论板块阶段一律剔除
