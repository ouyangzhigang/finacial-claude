...
⚠️ 对综合得分前N必须跑该因子组合近3年回测,要求：年化超额 > 0、最大回撤 < 该因子历史最大回撤、夏普 > 0.3。**分级处置**：① 任一不达标且综合得分最高者 → **不得排Top1/Top3**,显著标注"回测未背书"；② 跳过本步则报告作废,不得输出精选个股表。因子筛选是定量工具,无回测背书的排名=未验证的断言（驰宏案即回测三项全不达标仍排Top1）。
